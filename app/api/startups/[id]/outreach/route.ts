...
export async function POST(request: Request, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    const result = await createIntelligenceOutreach({
      ...
      recipientContactId: typeof input.recipientContactId === "string" ? validateResourceId(input.recipientContactId, "Founder contact") : null,
      ...
      contactRepository: getFounderContactRepository(),
    });
